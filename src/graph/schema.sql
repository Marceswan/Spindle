-- Spindle graph schema. See section 8.1 of sfdx-graph-mcp-design.md.
-- Apply pragmas and tables on a fresh database; subsequent migrations live in
-- src/graph/migrations/ and are dispatched from store.ts based on schema_version.
